...
const ngrok_URL = 'https://ae49-84-252-157-90.ngrok-free.app';
...
async function handleRequest(req) {
    ...
    const additionalText = `Это ответ на заднный пользователем "${req.body.message.from.first_name} ${req.body.message.from.last_name}" следующий вопрос:`;
